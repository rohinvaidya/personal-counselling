...
{  
  ...
  $query = "SELECT * FROM USER WHERE ID = $client_id";
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <p class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">User Profile</p>
        <!-- Form -->
          ...
          <div class="card card-profile shadow">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <?php echo "<img src='../../storage/images/$profilepicpath' class='rounded-circle'>"?>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                <?php echo $first_name?><span class="font-weight-light"></span>
                </h3>
              </div>
            </div>
          </div>
