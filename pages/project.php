...
<html lang="en">
    <head>
        ...
        <!--FAVICON-->
        <link rel="shortcut icon" href="../assets/project/images/w.png">
        ...
        <!--FONTAWESOME-->
        <link rel="stylesheet" href="../assets/project/plugin/font-awesome-4.7.0/css/font-awesome.min.css">
                ...
                <div class="container-fluid">
                    <div class="wg-nav-wrapper">
                        <div class="navbar-header">
                            ...
                            <a href="#home" class="navbar-brand">CONVOCARE</a>
                        </div>
